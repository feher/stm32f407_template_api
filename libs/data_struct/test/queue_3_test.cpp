...
TEST(CircularQueue_3, BasicAssertions)
{
...
TEST(CircularQueue_3, FullAndEmptyQueue)
{
    QueueType<int, 4> queue;
...
TEST(CircularQueue_3, Concurrency_1_Producer_1_Consumer)
{
...
TEST(CircularQueue_3, Concurrency_N_Consumer)
{
...
TEST(CircularQueue_3, Concurrency_N_Producer)
{
...
TEST(CircularQueue_3, Concurrency_N_Producer_M_Consumer)
{
    // TEST: Multiple producers, multiple consumers.
    // Create and run producer and consumer threads.
...
TEST(CircularQueue_3, Concurrency_N_Producer_M_Consumer_Multiqueue)
{
    // TEST: Multiple producers, multiple consumers.
    // Create and run producer and consumer threads.
    // Producers take items from the input queue and put them to the work queue.
