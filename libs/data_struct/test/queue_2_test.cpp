...
#include <data_struct/circular_queue_2.hpp>
...
TEST(CircularQueue_2, BasicAssertions)
{
...
TEST(CircularQueue_2, FullAndEmptyQueue)
{
    QueueType<int, 4> queue;
...
TEST(CircularQueue_2, Concurrency_1_Producer_1_Consumer)
{
    constexpr auto itemCount = 1024;
...
TEST(CircularQueue_2, Concurrency_N_Consumer)
{
    constexpr auto consumerThreadCount = 8;
    constexpr auto consumerItemCount = 2048;
...
TEST(CircularQueue_2, Concurrency_N_Producer)
{
    constexpr auto producerThreadCount = 4;
    constexpr auto producerItemCount = 2048;
...
TEST(CircularQueue_2, Concurrency_N_Producer_M_Consumer)
{
    // TEST: Multiple producers, multiple consumers.
    // Create and run producer and consumer threads.
...
TEST(CircularQueue_2, Concurrency_N_Producer_M_Consumer_Multiqueue)
{
    // TEST: Multiple producers, multiple consumers.
    // Create and run producer and consumer threads.
    // Producers take items from the input queue and put them to the work queue.
