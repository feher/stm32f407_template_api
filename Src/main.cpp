...
class ButtonDebouncer : public Ao::ActiveObject<Event, 10>
{
public:
...
class LedToggler : public Ao::ActiveObject<Event, 10>
{
public:
...
class SpiTester : public Ao::ActiveObject<Event, 10>
{
public:
...
int main(void)
{
    ...
    buttonInterruptSender.registerReceiver(&buttonDebouncer);
    Ao::EventSender<Event> timerInterruptSender;
    timerInterruptSender.registerReceiver(&buttonDebouncer);

    LedToggler ledToggler{gpioD};
    buttonDebouncer.registerReceiver(&ledToggler);
